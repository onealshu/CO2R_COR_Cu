...
def main():
    folders = ["Sargent_acidicCO2R-Cu","Bertheussen_COR", "Bertheussen_COR-pcCu", "Gregorio_CO2R","Hahn_CO2R","Huang_CO2R",
               "Kanan_CO2R-ODCu", "Kanan_COR-ODCu", "Kuhl_CO2", "Wang_COR",
               "Wang_COR-Cuflower", "Raciti_COR",
               "Jouny_COR", "Luc_COR", "Ma_CO2R", "Manthiram_CO2R", "Ren_CO2R","Sargent_CO2R-CuN-C", "Varela_CO2R","Zuettel_CO2R", "Kanan_COR-GDE",
               "Yeo_CO2R"]
#    folders = ["Sargent_acidicCO2R-Cu","Bertheussen_COR", "Bertheussen_COR-pcCu", "Huang_CO2R",
