...
if __name__ == "__main__":
    folders = ["Sargent_acidicCO2R-Cu","Beatriz_CO2R_Cu100","Beatriz_CO2R_Cu111","Bertheussen_COR","Bertheussen_COR-pcCu",
               "Gregorio_CO2R","Hahn_CO2R","Huang_CO2R","Jouny_COR","Kanan_CO2R-ODCu","Kanan_COR-GDE",
               "Kanan_COR-ODCu","Kanan_COR-ODCuII","Kuhl_CO2","Luc_COR","Luc_COR_II","Ma_CO2R","Manthiram_CO2R",
               "Raciti_COR","Ren_CO2R","Sargent_CO2R-CuN-C","Varela_CO2R","Wang_COR","Wang_COR-Cuflower",
               "Yeo_CO2R","Zuettel_CO2R"
               ]

    # collect all data
    data = load_pkl_data(folders)
    maxpH = 100.
    for ads in ['Acetate', 'Acetaldehyde', 'Ethanol', 'Ethylene', 'Hydrogen', 'Methane', 'Formate', 'CO']:
